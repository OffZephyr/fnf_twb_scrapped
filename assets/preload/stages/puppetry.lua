function onCreate()
	...
	makeLuaSprite('0f', 'backgrounds/puppetrybg', -750, -450);
	...
	makeLuaSprite('4f', 'backgrounds/fabric4', -1150, -650);
	setLuaSpriteScrollFactor('4f', 1.1, 1.1);
	addLuaSprite('4f', true);
    scaleObject('4f', 0.75, 0.75)
	
	makeLuaSprite('5f', 'backgrounds/fabric5', -1000, -575);
