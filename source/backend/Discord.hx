...
class DiscordClient
{
	...
	private static var _defaultID:String = "1030952505150013510";
	...
	private static var _options:Dynamic = {
		...
		state: null,
		largeImageKey: 'icon',
		largeImageText: "FNF: The World Below",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Mod Version: " + states.MainMenuState.modVersion;
