...
class Alphabet extends FlxSpriteGroup
{
	...
	public var isMenuItemCredits:Bool = false;
	...
	public var distancePerItem:FlxPoint = new FlxPoint(50, 120);
	public var distancePerItemCredits:FlxPoint = new FlxPoint(0, 100);
	...
	override function update(elapsed:Float)
	{
		...
		if (isMenuItemCredits)
		{
			var lerpVal:Float = FlxMath.bound(elapsed * 9.6, 0, 1);
			if(changeX)
				x = 50;
			if(changeY)
				y = FlxMath.lerp(y, (targetY * 0.8 * distancePerItem.y) + startPosition.y, lerpVal);
		}
	...
	public function snapToPosition()
	{
		...
		if (isMenuItemCredits)
		{
			if(changeX)
				x = 50;
			if(changeY)
				y = (targetY * 0.8 * distancePerItem.y) + startPosition.y;
		}
	}
